...
**4. Next.js에서 라우팅은 어떻게 구현되며, React Router와는 어떤 차이가 있나요?**
...
**5. Next.js 13의 App Router와 기존 Pages Router의 차이는 무엇인가요?**
...
**6. Route Groups 기능은 무엇이며, 어떤 상황에서 활용할 수 있나요?**
...
**7. Next.js에서 동적 경로(Dynamic Route)는 어떻게 처리하나요?**
...
**9. `<Link>` 컴포넌트와 일반 `<a>` 태그의 차이는 무엇인가요?**
...
**10. `<Link>` 컴포넌트의 prefetching 기능은 어떤 장점을 가지고 있나요?**
